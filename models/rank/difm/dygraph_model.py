...
class DygraphModel():
    ...
    def create_model(self, config):
        ...
        qkv_dim = config.get('hyper_parameters.qkv_dim')
        dense_layers_size = config.get('hyper_parameters.dense_layers_size')


        deepfm_model = net.DIFMLayer(sparse_feature_number,
                                       sparse_feature_dim, dense_feature_dim,
                                       sparse_input_slot - 1, layer_sizes_dnn,dense_layers_size,num_heads,qkv_dim)
